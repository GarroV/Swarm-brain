...
| T152 | orchestrator | T147 | todo | Встреча бота длиннее 15 минут не помечается упавшей сторожем встреч-призраков `sweepStuckMeetings` (бот заявляет встречу до захода, запись отдаёт в конце) — воспроизвести тестом, починить | #549 | 1 |
