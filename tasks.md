...
| T002 | chores | — | todo | Поставить `scripts/check`, `scripts/gate-coverage.sh`, `.githooks/pre-push`, карантин версий в `bot/.npmrc`; прогнать на испорченной копии и убедиться, что краснеет | #324 | 1 |
...
| T101 | chores | — | blocked:Q006 | Завести `scriba` Google-аккаунт и порядок добавления его в календарные приглашения | #361 | 2 |
