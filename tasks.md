...
| T147 | orchestrator | T072 | in_progress | Серверный сторож `checkRecorderHealth` видит heartbeat бота из `service_agents` (D007), и живой контейнер не прячет мёртвый при двух встречах сразу — половина DoD T071 | #547 | 1 |
