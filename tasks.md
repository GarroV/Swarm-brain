...
| T149 | identity | T017 | todo | Приглашение бота (D017): сервер заводит одноразовую запись «кто позвал, ссылка, срок» по запросу залогиненного человека; ручную встречу агент заводит в meeting-claim только по действующему приглашению, без него — 403; приглашение гасится после использования. Миграция — одна в волне | — | 1 |
