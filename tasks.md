...
| T028 | core | T003,T024 | done | `spaceAnalytics.ts` и `buildSpaceReport`: семь таблиц и markdown, сверка с ручным пересчётом. Тесты вперёд | — | 4 |
| T029 | web | T028 | done | Экран «Аналитика»: семь таблиц с сортировками эталона | — | 4 |
| T030 | web | T013 | done | Экран «Журнал»: события по дням с фильтром периода | — | 4 |
| T031 | web | T028 | done | Выгрузка итогов в markdown: в буфер синхронно по нажатию, запасное поле при отказе (D009) | — | 4 |
| T032 | demo | T005 | done | Демо-сид: пространство, направления, инициативы, живой спринт с отметками, принятый спринт с итогами; по-английски, имена выдуманные, идемпотентно | — | 4 |
