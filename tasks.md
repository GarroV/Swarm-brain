...
| T071 | orchestrator | T070,T151 | in_progress | Heartbeat идёт; смерть контейнера посреди встречи видна существующему watchdog | #353 | 1 |
...
| T140 | chores | — | in_progress | Промпт тезисов устойчив к недоверенному тексту стенограммы: данные отделены от инструкции | #458 | 2 |
