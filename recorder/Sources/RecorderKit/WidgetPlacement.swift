...
public enum WidgetPlacement {
    ...
    /// «поднять на 2 таких же фрейма». Два фрейма = две высоты баннера встречи (84×2):
    /// величина в пунктах, а не «2 × size.height», чтобы капсула (110) и баннер (84) вставали
    /// на одну и ту же линию — иначе при переключении режима окно прыгало бы по вертикали.
    public static let defaultLift: CGFloat = 168
