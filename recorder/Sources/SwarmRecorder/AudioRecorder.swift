...
final class AudioRecorder: NSObject {
    ...
    // Пик системной дорожки за интервал с прошлого вызова (для детекта тишины; см. протокол).
    func systemPeakSinceLastRead() -> Float {
        systemCapturer?.peakSinceLastRead() ?? 0
    }
