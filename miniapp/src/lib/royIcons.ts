...
export const ROY_ICON_PATHS = {
  ...
  // Тема: солнце / луна / монитор («как в системе») — переключатель в рейке.
  sun: "M10 13.2a3.2 3.2 0 100-6.4 3.2 3.2 0 000 6.4zM10 2.5v1.6M10 15.9v1.6M2.5 10h1.6M15.9 10h1.6M4.7 4.7l1.1 1.1M14.2 14.2l1.1 1.1M4.7 15.3l1.1-1.1M14.2 5.8l1.1-1.1",
  moon: "M15.6 12.2A6.2 6.2 0 017.8 4.4a6.2 6.2 0 107.8 7.8z",
  monitor: "M3 4.5h14v9H3zM7.5 16.5h5M10 13.5v3",
} as const;
