  ...
  return (
    <div className={cn("relative", className)}>
      {open && (
        <>
          ...
          <div
            ...
            className={cn(
              "z-50 flex flex-col overflow-hidden rounded-[10px] border border-line bg-[var(--popover)] shadow-[0_24px_64px_-18px_rgba(0,0,0,.5)] dark:backdrop-blur-xl",
      ...
      <button
        ...
        aria-expanded={open}
        className="relative flex size-10 items-center justify-center rounded-[8px] border border-line bg-surface shadow-[0_4px_14px_-8px_rgba(27,32,40,.25)] transition-colors hover:bg-surface-2 active:scale-[0.97] dark:backdrop-blur-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)]"
      >
