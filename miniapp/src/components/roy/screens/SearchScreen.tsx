    ...
    <div className="h-full overflow-y-auto">
      ...
      <div className="px-5 pt-2">
        <form onSubmit={(e) => { e.preventDefault(); go(q); }}>
          <div className="flex items-center gap-2.5 bg-surface border border-line-2 focus-within:border-primary dark:backdrop-blur-md" style={{ borderRadius: 10, padding: "13px 15px" }}>
