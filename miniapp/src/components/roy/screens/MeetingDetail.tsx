      ...
      {menu && (
        <>
          ...
          <div className="roy-pop absolute right-4 top-14 z-50 overflow-hidden rounded-[14px] border border-line bg-surface shadow-[0_10px_30px_rgba(0,0,0,.18)]">
            <button type="button" onClick={() => { setMenu(false); setDraft(e?.summary ?? ""); setEditing(true); }} className="block w-full px-5 py-2.5 text-left font-medium text-ink" style={{ fontSize: 14 }}>
              Изменить тезисы
            </button>
