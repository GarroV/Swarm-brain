  ...
  return createPortal(
    <div className="fixed inset-0 z-[70] flex items-stretch justify-center bg-black/40 sm:items-start sm:p-6 sm:pt-[6vh]" onClick={onClose}>
      <div
        ...
        className="flex w-full flex-col overflow-hidden border border-line bg-[var(--popover)] shadow-[0_24px_64px_-18px_rgba(0,0,0,.5)] dark:backdrop-blur-xl sm:max-w-[760px] sm:rounded-[14px]"
