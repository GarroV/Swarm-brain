...
export const ROY_ICON_PATHS = {
  ...
  // Виды задач (лайн-арт «консоли»): таймлайн = смещённые бары, доска = колонки, граф = узлы+рёбра.
  timeline: "M3 5.5h6M7 10h9M4 14.5h6",
  board: "M3.5 4.5h13v11h-13zM8 4.5v11M12.5 4.5v11",
  graph: "M7 6.1 13 5.6M6.3 7.4 9.3 13M13.7 6.6 10.7 13M3.9 6a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0M12.9 5.5a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0M8.4 14.5a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0",
} as const;
