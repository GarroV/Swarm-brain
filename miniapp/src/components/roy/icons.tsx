...
export const ROY_ICON_PATHS = {
  ...
  // Шестерёнка — «в работе» у статуса задачи: ступица + восемь зубьев. Ручку (pencil) взять
  // нельзя, она уже означает «Изменить» в 14 местах, в том числе в самой строке задачи.
  gear: "M10 6.6a3.4 3.4 0 100 6.8 3.4 3.4 0 000-6.8M10 2.4v1.9M10 15.7v1.9M3.3 6.2l1.65.95M15.05 12.85l1.65.95M3.3 13.8l1.65-.95M15.05 7.15l1.65-.95",
