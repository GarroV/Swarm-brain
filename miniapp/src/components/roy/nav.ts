...
// Типы маршрутов живут в lib/royRoute.ts (данные отдельно от React — их типизирует
// чистая логика lib/royUrl.ts, которую проверяет Deno). Ре-экспорт оставлен: полтора
// десятка файлов импортируют RoyTab/RoyRoute отсюда.
import type { RoyRoute, RoyTab } from "@/lib/royRoute";
export type { RoyRoute, RoyTab };
