...
// Кнопка «Копировать» над тезисами встречи. Формат шапки (крупно встреча и дата, мелко пометка
// об AI) — в lib/tezisyCopy.ts. Решение владельца 03.09.2026 (уточнено в тот же
