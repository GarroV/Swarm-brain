...
export type Entry = {
  ...
  // (кросс-источниковый дедуп, issue #170). Значит в базе чужая версия тезисов, а правки
  // вычитавшего никуда не уехали — интерфейс обязан сказать это, а не «опубликовано».
  duplicate?: boolean;
