...
**Командная база знаний, которая помнит за вас.** Итоги встреч, задачи и документы команды — в одном месте, с ответами на обычном языке. Работает там, где команда уже сидит: в Telegram, в браузере, в Claude Desktop и с собственного рекордера звонков на Mac.
...
**Знания команды перестают теряться в чатах, дисках и чужих головах.** Swarm Brain держит встречи, задачи и документы в одном месте и отвечает на вопросы обычным языком — из Telegram, браузера или Claude Desktop, а рекордер звонков сам пишет и расшифровывает встречи. Одна база — четыре двери, что создал в одной, видно в остальных.
...
1. **Созвон** идёт в Meet или Контур.Толк. **SwarmRecorder** — приложение в меню-баре Mac — пишет две звуковые дорожки: вас и собеседников.
