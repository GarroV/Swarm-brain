...
Интерактивная витрина: задачи (доска / спринт / граф / линзы), встречи с тезисами и вычиткой, база знаний, поиск + AI-ответ, персональный дайджест. Отдельный **изолированный** тестовый воркспейс — не связан с рабочими данными (сессия не админ, доступа к чужим воркспейсам нет). Можно свободно тыкать и создавать; данные периодически сбрасываются к эталону.
