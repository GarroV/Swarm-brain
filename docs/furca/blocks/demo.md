...
Демо-пространство: сид, по которому доска открывается заполненной — направления, инициативы, живой
спринт с отметками сверки и один принятый спринт с итогами. Отдельный блок, потому что демо обязано быть
изолированным от настоящих данных и на английском, а его содержание — продуктовое решение, а не побочный
эффект экрана.
...
Дополнение `supabase/demo-seed.sql`: идемпотентно, воркспейс `demo`, английские выдуманные имена и
названия. Никаких данных «Качества».
...
| 4 | сид идемпотентен: повторный прогон не задваивает строки |
| 4 | заполнены пространство, направления, инициативы, живой спринт, отметки сверки, принятый спринт с итогами |
| 4 | всё по-английски, имена выдуманные; настоящих данных нет |
| 4 | демо-ссылка открывает доску без регистрации, аналитика и журнал не пустые |
