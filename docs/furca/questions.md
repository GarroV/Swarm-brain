...
| Q004 | open | — | Пока бот и `bumblebee` пишут одну встречу параллельно, аудио оплачивается в OpenAI дважды. Терпим на время проверки или отбраковывать дубль до транскрибации? Связано с #311, #312. | — |
