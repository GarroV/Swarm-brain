...
| Q001 | open | — | Есть ли дата или событие, к которому «Качество в Европе» должно переехать в Swarm? Рекомендация: без жёсткой даты — этапы 1–4 по готовности, каждый ночной раскаткой. sent 2026-09-18 | — |
| Q002 | open | — | Подтверди список «что нельзя ломать» (анкета C, 8 пунктов из спеки §9) и критерий успеха MVP (анкета A) — или поправь. Рекомендация: принять как есть. sent 2026-09-18 | — |
