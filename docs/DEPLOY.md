...
**`supabase db push --linked` — штатный и единственный путь.** Работает с 05.09.2026, до этого был
неприменим (см. ниже). Правила вокруг него:
...
- `db push` = раскатка: только по явному «да» владельца и в окно 23:00–05:59 (см. `CLAUDE.md` §5).
