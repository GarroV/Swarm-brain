...
> 🚦 **Раскатка на прод — отдельное действие с отдельным «да» владельца** (решение 24.08.2026, канон — [decisions/2026-08-24-deploy-window.md](decisions/2026-08-24-deploy-window.md)). Окно: **23:00–05:59 по Белграду, любой день** (утреннее 09:00–10:00 отменено 27.08.2026, канон [decisions/2026-08-27-deploy-at-night.md](decisions/2026-08-27-deploy-at-night.md)); штатный путь — метка `deploy-window` на PR, ночью его вольёт автоматика. Пуш в `main` считается раскаткой (веб собирается с `main` автоматически). Накопитель: `make deploy-plan` / `make deploy` (`scripts/deploy-window.sh`, метка `prod-deployed`). Ночная автоматика уже в расписании — `.github/workflows/deploy-window.yml` (репозиторий публичный с 27.08, минуты Actions бесплатны).
