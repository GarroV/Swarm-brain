...
| Роль | Размер | Где |
|---|---|---|
| Заголовок экрана/детали (`pageTitle`) | **24px / 700 / -0.02em** | `RoyHeader` (Встречи/База/мобайл) + Задачи/Таймлайн/Спринт/Граф/деталь задачи/встречи/записи/ревью/Суперадмин — все приведены к одному |
