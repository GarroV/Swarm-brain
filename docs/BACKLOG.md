...
- 🟡 **Осталось:** подтянуть классификатор страны/типа (LLM мис-тег Испания→RS, заметка-со-ссылками→meeting). Ручная правка уже есть — экран «Ревью встреч» (реклассификация/правка/мерж).
