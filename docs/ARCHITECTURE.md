...
2. **Поиск / ответ.** Вопрос боту или в вебе → гибридный поиск (смысл + точные слова + буст по стране и свежести) + RAG-ответ со сносками на источники.
