...
| `get_users` | Список пользователей воркспейса, **включая владельца** (до 25.09.2026 он был исключён без причины — агент не находил его в команде, issue #502) |
