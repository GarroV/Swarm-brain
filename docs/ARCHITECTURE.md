...
| любая другая | только `manual` | ничего: решение D016; ручной запуск по приглашению сервера вынесен владельцу вопросом Q008 | как прислано (ветка не тронута) |
...
комнатная встреча без состава открыта агенту любого человека своего воркспейса; ручная — без сверки (Q008).
