...
export const MEETING_GLOSSARY: GlossaryEntry[] = [
  ...
  { canonical: "Београд", aliases: ["билбрайд"], note: "город; пиццерии называются «Београд ‹номер›» — шаблон применим ТОЛЬКО когда в записи прозвучал сам Београд/«билбрайд», чужие названия к нему не приводить (issue #72: «ИСА-2» → ошибочно «Београд 2»)" },
  { canonical: "Нови Сад", aliases: ["новейсайд", "нови сайд"], note: "город; пиццерии называются «Нови Сад ‹номер›»" },
  // Подтверждено владельцем 2026-08-24 (issue #72): «ИСА-2» в стенограмме — это пиццерия
  // «Нови Сад 2». Без этой записи модель дотянула незнакомое название до знакомого шаблона
  // и написала «Београд 2» — визит уехал в другой город.
  { canonical: "Нови Сад 2", aliases: ["иса-2", "иса 2", "иса2", "нс-2"], note: "пиццерия в Нови Саде; в речи Whisper слышит её как «ИСА-2». Это НЕ Београд" },
