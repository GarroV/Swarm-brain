...
// Регресс issue #75: «Крошка Антошка» — устойчивая галлюцинация на тишине, встретилась в ДВУХ
// разных записях 19.08.2026 («Настоящий рабочий мит» сегмент 1, «Dodo Pizza Serbia» сегмент 613)
// и уехала в тезисы. Вариант «Добро пожаловать на канал …» мимо списка не проходил: там стояло
// жёсткое «на НАШ канал».
Deno.test("ловит «Крошка Антошка» и «Добро пожаловать на канал» без слова «наш»", () => {
  assert(isWhisperHallucination("сейчас на нашем канале Крошка Антошка Твиттера!"));
  assert(isWhisperHallucination("Добро пожаловать на канал Крошка Антошка ТВ!"));
  assert(isWhisperHallucination("Добро пожаловать на наш канал!"));
});

Deno.test("живая речь про канал продаж галлюцинацией не считается", () => {
  assert(!isWhisperHallucination("Надо активнее работать с каналом продаж и клиентской базой"));
});
