...
export const COUNTRY_PROMPT_RULE =
  ...
  "Croatia, Slovenia, …). Город указывает на свою страну: Сабадель/Барселона → Spain, Белград → " +
  "Serbia, Варна → Bulgaria. ВАЖНО: НЕ тегируй страну, которая лишь упомянута вскользь или к которой " +
  "относятся только участники/команда, — нужна суть про рынок, а не упоминание. Если запись о " +
  "СКВОЗНОЙ/общей теме (инструменты, ИТ, процессы, обучение, демо, методология) и не привязана к " +
  "конкретному рынку — пустой массив []. Если страна/рынок явно не предмет — []. НЕ угадывай и НЕ " +
  "подставляй страну по умолчанию.";
