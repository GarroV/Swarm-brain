...
// Формат по запросу владельца 2026-07-25: «Добавлено в базу: N» (+ список названий встреч и
// документов, если N>0) и «На вычитке: M» — вся текущая очередь невычитанных встреч
// (status=awaiting_review), как стоячее напоминание подтвердить. «Тихий день» — ТОЛЬКО когда
// и добавленных, и висящих на вычитке ноль (иначе прод-день с кучей записей, но без ревью,
// ошибочно выглядел «тихим» — разбор 2026-07-25). reviewCount приходит из таблицы meetings
